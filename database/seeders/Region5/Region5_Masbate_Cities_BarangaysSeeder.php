...
class Region5_Masbate_Cities_BarangaysSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        // Masbate Cities
        $csvFile[0] = fopen(base_path("database/data/Province_Masbate_Cities/Masbate_MasbateCity_Barangays.csv"), "r");
