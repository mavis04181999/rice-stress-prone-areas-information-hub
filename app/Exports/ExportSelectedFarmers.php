...
class ExportSelectedFarmers implements FromArray, WithHeadings

{

    use Exportable;

    public function __construct(array $selectedFarmers)
    {
        $this->selectedFarmers = $selectedFarmers;
    }
    ...
    public function getPickListItemVal(int $id) : string
    {
        ...
        return strval($item->Picklistitem);
    }
    ...
    public function array():array
    {
        ...
        $farmers = Farmer::whereIn('id', $this->selectedFarmers)
