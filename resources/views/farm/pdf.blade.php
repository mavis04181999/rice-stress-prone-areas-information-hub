...
<body class="login-page" style="background: white">
    ...
    <div>
        <div class="row">
            ...
            <div class="col-xs-4">
                 <img src="https://res.cloudinary.com/dkem6chwr/image/upload/v1667222855/Department_of_Agriculture_Logo_adtmsf.png" width="701" height="165" alt="logo">
                {{-- <img src="{{ asset('pdf/logo_da.png')}}" class="" height="165" alt="logo">  --}}
            </div>
        </div>
